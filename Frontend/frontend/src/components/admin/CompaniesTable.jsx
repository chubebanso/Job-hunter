...
import { toast } from 'sonner'; // for displaying notifications (optional)
...
const CompaniesTable = () => {
    ...
    const fetchCompanies = async () => {
        ...
        try {
            ...
            console.log('Kết quả từ API:', response.data); // Kiểm tra kết quả API
            setFilterCompany(Array.isArray(response.data) ? response.data : []);
        } catch (error) {
            console.error('Lỗi khi lấy danh sách công ty:', error);
            toast.error(error.response?.data?.message || 'Lỗi khi lấy công ty');
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(createResponse.data.message || 'Tạo công ty thành công.');
            ...
            toast.error(error.response?.data?.message || 'Tạo công ty thất bại. Vui lòng thử lại.');
        }
    };
